...
class NotificationService:
    def __init__(self, notification_repository: NotificationRepository):
        self.notification_creator = NotificationCreator(notification_repository)
        ...
        self.notification_repository = notification_repository  # Acceso directo al repositorio

    def create_notification(self, user_id: int, title: str, content: str, type: str, link: str = None):
        self.notification_creator.create(user_id, title, content, type, link)
